  ...
  <div class="admin_login">
    <div class="login_block">
      <div class="login_title">
        <h4>管理员登录</h4>
        <font-awesome-icon color="#F56C6C" :icon="['fas', 'exclamation-triangle']" class="fa-4x"></font-awesome-icon>
      </div>
...
<script>
import {geetestAdmin, adminLogin} from '../../api'
